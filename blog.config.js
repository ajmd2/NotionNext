...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ajmd2048', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'lfy', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lsldbb.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'RL, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '有的兄弟有的，像gpt这么超模的大模型一共还有9位，都是当前模型界t0.5的超标模型🎉',
